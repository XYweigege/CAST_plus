...
| [API_INTEGRATION.md](./API_INTEGRATION.md) | 数据源接入指南：对接真实业务系统、文件格式、接口参考 |

## 建议阅读顺序

| 目的 | 顺序 |
|------|------|
| 跑起来看效果 | `LOCAL_SETUP.md` → `README.md` |
| 理解后端实现 | `README.md` → `BACKEND.md` |
| 理解为什么这么设计 | `README.md` → `DEVELOPMENT.md` |
| 接手继续开发 | `BACKEND.md` → `API_INTEGRATION.md` |
| 了解完整需求与验收 | `REQUIREMENTS.md` |
